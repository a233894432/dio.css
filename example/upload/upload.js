...
(function(global, factory) {
  ...
  var ss = window.ss || {},
    ...
    // Detect IE7-9
    isIE7to9 =
      navigator.userAgent.indexOf("MSIE") !== -1 && navigator.userAgent.indexOf("MSIE 1") === -1,
  ...
  ss.SimpleUpload.prototype = {
    ...
    setForm: function(form) {
      ...
      if (!this._form || this._form.nodeName.toUpperCase() != "FORM") {
        ...
        var self = this;
        // onchange file autoSubmit upload
  ...
  ss.IframeUpload = {
    ...
    _initUpload: function(fileObj) {
      ...
      this._hasProgUrl =
        this._opts.progressUrl || this._opts.sessionProgressUrl || this._opts.nginxProgressUrl
          ? true
          : false;
  ...
  ss.XhrUpload = {
    _addFiles: function(files) {
      ...
      for (i = 0; i < total; i++) {
        ...
        if (
          false === this._opts.onChange.call(this, filename, ext, this._overBtn, size, files[i])
        ) {
          return false;
        }
